...
Sona credits must be completed by [5pm on the last day of classes]{.underline}. If you have fewer than 8 credits by that time, your grade will be lowered by one "step" (i.e., from B+ to B, from C- to D, from D to F). Each study lists how many credits it offers at a rate of 1 credit per 15 minutes of participation, and a 1 credit bonus for in-person studies.
