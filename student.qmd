...
If you have [***never***]{.underline} used Sona before, you must go to [http://rit.sona-systems.com](#0) (or click the link at the top of the page) and create an account.

If you [***have***]{.underline} used SONA through RIT previously, log in, or use the password recovery feature to reactivate your account. [Do not create a new one.]{.underline}
